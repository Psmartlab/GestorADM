...
const SECTIONS = [
  ...
  { id: 'security', label: 'Segurança', icon: Shield, color: 'text-emerald-500 bg-emerald-500/10' },
  { id: 'permissions', label: 'Permissões', icon: Users, color: 'text-accent bg-accent/10' },
  ...
  { id: 'data', label: 'Dados e Backup', icon: Database, color: 'text-blue-500 bg-blue-500/10' },
];
